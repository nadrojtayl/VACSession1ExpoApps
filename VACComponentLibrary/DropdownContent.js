...
class DropdownContent extends Component{
  ...
  renderContent(){
    var that = this;
      ...
      return ( 
      <View style = {{width:"100%",height:"80%", alignItems:'center', justifyContent:'center', backgroundColor:"rgb(242,242,247)"}}>
  ...
  render(){
    var that = this;
    return (<View style = {{height:"70%", width:"100%", alignItems:'center'}}>
      <View style = {{flexDirection:'row', height:"10%", width:"80%", justifyContent:'space-evenly', alignItems:'space-evenly'}}>
       ...
       <View style = {{height:"80%",width:"100%", marginTop: "40%", alignItems:'center'}}>
        {
